...
"""
Created on Mon Apr 17 17:41:39 2023
...
# 输入文件
node_file_name = './output/骆驼祥子-人物节点.csv'
link_file_name = './output/骆驼祥子-人物连接.csv'

# 输出文件
out_file_name = './output/骆驼祥子.html'
...
for one_line in node_line_list:
    ...
    node_in_graph.append(opts.GraphNode(
            ...
            symbol_size=int(one_line_list[1])/25))  # 手动调整节点的尺寸
#print('-'*20)  # 测试点
link_in_graph = []
...
c.set_global_opts(title_opts=opts.TitleOpts(title="骆驼祥子人物共现分析"))
c.render('骆驼祥子人物共现分析.html')
